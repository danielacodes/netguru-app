...
RSpec.describe CommentsController, type: :controller do
 ...
 # }
  ...
  before(:all) do 
    ...
    @released_at = "1989"
    @movie = Movie.create(id: @movie_id, title: @title, description: @description, released_at: @released_at)
    
    @id = 10
    @user_name = "user" 
    @body = "MyText" 
    @movie_id = 1
    @comment = Comment.create(id: @id, user_name: @user_name, body: @body, movie_id: @movie_id)
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the movie show view" do
      delete :destroy, params: {id: @comment.to_param}
      expect(response).to redirect_to(Movie)
    end
  end
